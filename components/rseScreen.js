        ...
        >
          <View style={styles.centeredView}>
            ...
            <View><Image source={checked1}/></View>
              <Text style={styles.modalText1}>¡Establecimiento registrado!</Text>
              <Text style={styles.modalText2}>El establecimiento han sido registrado satisfactoriamente</Text>         
