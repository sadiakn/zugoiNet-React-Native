...
class rsScreen extends Component {
  state = {
    modalVisible: false
  };
        ...
        >
          <View style={styles.centeredView}>
            ...
            <View><Image source={checked1}/></View>
              <Text style={styles.modalText1}>¡Producto registrado!</Text>
              <Text style={styles.modalText2}>El Producto ha sido registrado satisfactoriamente</Text>         
